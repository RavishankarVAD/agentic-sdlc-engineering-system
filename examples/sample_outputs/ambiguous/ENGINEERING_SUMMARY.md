...
## Ambiguities
- 'fast' is not quantified; define a measurable target.
- 'scalable' is not quantified; define a measurable target.
- 'secure' is not quantified; define a measurable target.
...
## Execution log
1. requirement-agent: normalized requirement; scenario=greenfield; ambiguities=3
